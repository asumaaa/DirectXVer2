/**
 * @file DebugLineModel.cpp
 * @brief デバッグ用 デバッグよう線分
 * @author Asuma Syota
 * @date 2023/11/8
 */
...
void DebugLineModel::CreateBuffers(ID3D12Device* device)
{
	HRESULT result;
...
void DebugLineModel::CreateVertex()
{
	//球体一つの基礎サイズ
...
void DebugLineModel::SetImageData(XMFLOAT4 color)
{
	HRESULT result;
	for (size_t i = 0; i < imageDataCount; i++)
	{
...
void DebugLineModel::Draw(ID3D12GraphicsCommandList* cmdList)
{
	//頂点バッファをセット
