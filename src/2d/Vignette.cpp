...
ID3D12Device* Vignette::device = nullptr;
ComPtr<ID3D12RootSignature>Vignette::rootsignature;
ComPtr<ID3D12PipelineState>Vignette::pipelinestate;
const float Vignette::clearColor[4] = { 0.25f,0.5f, 0.1f, 0.0f };
...
void Vignette::Draw(ID3D12GraphicsCommandList* cmdList)
{
...
void Vignette::CreateGraphicsPipeLine()
{
	...
	result = D3DCompileFromFile(
		L"Resources/Shaders/Vignette/VignetteVertexShader.hlsl",
		nullptr,
	...
	//ピクセルシェーダの読み込み コンパイル
	result = D3DCompileFromFile(
		L"Resources/Shaders/Vignette/VignettePixelShader.hlsl",
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE,
		"main", "ps_5_0",
		D3DCOMPILE_DEBUG | D3DCOMPILE_SKIP_OPTIMIZATION,
...
void Vignette::PreDrawScene(ID3D12GraphicsCommandList* cmdList)
{
	//リソースバリアを変更
...
void Vignette::PostDrawScene(ID3D12GraphicsCommandList* cmdList)
{
	//リソースバリアを変更
	CD3DX12_RESOURCE_BARRIER a0 = CD3DX12_RESOURCE_BARRIER::Transition(
		textureBuff.Get(),
