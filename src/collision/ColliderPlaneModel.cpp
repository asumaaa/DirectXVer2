...
void ColliderPlaneModel::CreateVertex()
{
	//球体一つの基礎サイズ
	...
	VertexPosNormalUv v[] = {
		//前
		{{-size.x / 2, 0.0f,-size.z / 2},{},{0.0f,1.0f} },	//0
		{{-size.x / 2, 0.0f, size.z / 2},{},{0.0f,0.0f} },	//1 
		{{ size.x / 2, 0.0f,-size.z / 2},{},{1.0f,1.0f} },	//2 
		{{ size.x / 2, 0.0f, size.z / 2},{},{1.0f,0.0f} },	//3
	};
	//インデックスデータ
	unsigned short in[] =
	{
...
void ColliderPlaneModel::SetImageData(XMFLOAT4 color)
{
	HRESULT result;
	for (size_t i = 0; i < imageDataCount; i++)
	{
...
void ColliderPlaneModel::Update()
{
	//-----この上に頂点の更新処理を書く-----
...
void ColliderPlaneModel::Draw(ID3D12GraphicsCommandList* cmdList)
{
	//頂点バッファをセット
