...
ComPtr<ID3D12RootSignature>FbxObject3DDemo::rootsignature0;
ComPtr<ID3D12PipelineState>FbxObject3DDemo::pipelinestate0;

ID3D12Device* FbxObject3DDemo::device = nullptr;
Camera* FbxObject3DDemo::camera = nullptr;
Light* FbxObject3DDemo::light = nullptr;
LightGroup* FbxObject3DDemo::lightGroup = nullptr;

void FbxObject3DDemo::Initialize()
{
	//1フレーム分の時間を60FPSで設定
...
void FbxObject3DDemo::Draw(ID3D12GraphicsCommandList* cmdList)
{
	//モデルの割り当てがなければ描画市内
	if (model == nullptr)
	{
...
void FbxObject3DDemo::CreateGraphicsPipeline()
{
	...
	result = D3DCompileFromFile(
		L"Resources/Shaders/FbxDemo/FbxDemoVertexShader.hlsl",    // シェーダファイル名
		nullptr,
	...
	// ピクセルシェーダの読み込みとコンパイル
	result = D3DCompileFromFile(
		L"Resources/Shaders/FbxDemo/FbxDemoPixelShader.hlsl",    // シェーダファイル名
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE, // インクルード可能にする
...
void FbxObject3DDemo::PlayAnimation()
{
